...
//        mpg.setTemplateEngine(new BeetlTemplateEngine());
        ...
        gc.setOutputDir(dirPath + "/UPMS - 副本 - 副本/src/main/java");
...
//        gc.setSwagger2(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/upms?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC");
...
//        strategy.setCapitalMode( !strategy.isCapitalMode());// 全局大写命名 ORACLE 注意
        strategy.setTablePrefix(new String[] { "t_bus_" });// 此处可以修改为您的表前缀
...
//        list.add(create_time);
        ...
        strategy.setInclude(new String[] { "t_bus_project_expense"}); // 需要生成的表
//        strategy.setInclude(scanner("user"));
//        strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
        // strategy.setExclude(new String[]{"test"}); // 排除生成的表
        // 自定义实体父类
         strategy.setSuperEntityClass("com.dlu.upms.common.entity.BaseEntity");
        // 自定义实体，公共字段
//        strategy.setSuperEntityColumns(new String[] { "CREATE_TIME", "CREATOR","UPDATE_TIME","OPERATOR" });
        ...
        pc.setParent("com");
        pc.setModuleName("dlu.upms.business");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return dirPath + "/UPMS - 副本 - 副本/src/main/resources/com/dlu/upms/business/mapper/"
